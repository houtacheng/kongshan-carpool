      ...
      <div className="max-w-5xl mx-auto px-4 py-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-black border border-stone-800 text-white flex items-center justify-center shadow-xs shrink-0 overflow-hidden p-1">
              <img src="/kongshan_logo.png" alt="空山寺" className="w-full h-full object-contain" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl md:text-2xl font-bold text-stone-900 tracking-tight flex items-center gap-1.5">
                  空山寺 <span className="text-sm md:text-base font-medium text-stone-600">法會共乘網</span>
                </h1>
